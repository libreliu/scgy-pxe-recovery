...
# locate in ./ only
EMBED_SCRIPT_TEMPLATE=boot_script_efi.ipxe.m
# desired output of the file, will be overrided by TEMPLATE_GENERATION PROCESS
EMBED_SCRIPT=boot_script_efi.ipxe

# expected binary name
EXPECTED_IPXE_EFI_OUTPUT=scgy-ipxe.efi
...
rm $EXPECTED_IPXE_EFI_OUTPUT

cp $EMBED_SCRIPT ./ipxe/src && cd ipxe/src && make bin-x86_64-efi/ipxe.efi EMBED="$EMBED_SCRIPT" NO_WERROR=1 && cp bin-x86_64-efi/ipxe.efi ../../ipxe.efi
mv ../../ipxe.efi "../../$EXPECTED_IPXE_EFI_OUTPUT"
